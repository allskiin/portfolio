...
sr.reveal(`.skills__content:nth-child(1), .contant__content:nth-child(1)`, { origin: 'left' })
sr.reveal(`.skills__content:nth-child(2), .contant__content:nth-child(2)`, { origin: 'right' })
