...
const comment1Form = document.getElementById('comment1-form'),
    ...
    comment1List = document.getElementById('comment1-list'),
...
const sendComment1 = (e) => {
    ...
    // Check if the field has a value
    if (comment1Name.value === '' || comment1Project.value === '' || comment1Number.value === '' || comment1List.value === '') {
        // Add and remove color
...
const comment2Form = document.getElementById('comment2-form'),
    ...
    comment2List = document.getElementById('comment2-list'),
...
const sendComment2 = (e) => {
    ...
    // Check if the field has a value
    if (comment2Name.value === '' || comment2Project.value === '' || comment2Number.value === '' || comment2List.value === '') {
        // Add and remove color
...
sr.reveal(`.skills__content:nth-child(1), .contact__content:nth-child(1), .comment__content:nth-child(1), .services__card:nth-child(1), .services__card:nth-child(2)`, { origin: 'left' })
sr.reveal(`.skills__content:nth-child(2), .contact__content:nth-child(2), .services__card:nth-child(3), .services__card:nth-child(4)`, { origin: 'right' })
